...
linear_full_rank<Vector>::f_min = 0.0;

template <typename Vector>
typename Vector::value_type
linear_full_rank<Vector>::tolerance = std::numeric_limits<typename Vector::value_type>::epsilon();

template <typename Vector>
std::vector<typename Vector::value_type>
linear_full_rank<Vector>::minima = {};

template <typename Vector>
std::vector<typename Vector::value_type>
linear_full_rank<Vector>::x0 = {};
