...
template <typename Vector>
typename Vector::value_type
freudenstein_roth<Vector>::tolerance = std::numeric_limits<typename Vector::value_type>::epsilon();

template <typename Vector>
std::vector<typename Vector::value_type>
freudenstein_roth<Vector>::minima = {5.0, 4.0};

template <typename Vector>
std::vector<typename Vector::value_type>
freudenstein_roth<Vector>::x0 = {0.5,  2.0};
