...
powell_badly_scaled<Vector>::f_min = 0.0;

template <typename Vector>
typename Vector::value_type
powell_badly_scaled<Vector>::tolerance = std::numeric_limits<typename Vector::value_type>::epsilon();

template <typename Vector>
std::vector<typename Vector::value_type>
powell_badly_scaled<Vector>::minima = {1.098e-05, 9.106};

template <typename Vector>
std::vector<typename Vector::value_type>
powell_badly_scaled<Vector>::x0 = {0.0,  1.0};
