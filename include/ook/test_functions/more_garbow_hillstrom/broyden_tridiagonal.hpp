#ifndef OOK_TEST_FUNCTIONS_MORE_GARBOW_HILLSTROM_BROYDEN_TRIDIAGONAL_HPP_
#define OOK_TEST_FUNCTIONS_MORE_GARBOW_HILLSTROM_BROYDEN_TRIDIAGONAL_HPP_
...
template <typename Vector, typename Matrix>
typename Vector::value_type broyden_tridiagonal<Vector, Matrix>::f_min = 0.0;

template <typename Vector, typename Matrix>
typename Vector::value_type broyden_tridiagonal<Vector, Matrix>::tolerance =
    std::numeric_limits<typename Vector::value_type>::epsilon();

template <typename Vector, typename Matrix>
std::vector<typename Vector::value_type>
    broyden_tridiagonal<Vector, Matrix>::minima = {};

template <typename Vector, typename Matrix>
std::vector<typename Vector::value_type>
    broyden_tridiagonal<Vector, Matrix>::x0 = {};
