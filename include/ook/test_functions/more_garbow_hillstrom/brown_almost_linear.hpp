#ifndef OOK_TEST_FUNCTIONS_MORE_GARBOW_HILLSTROM_BROWN_ALMOST_LINEAR_HPP_
#define OOK_TEST_FUNCTIONS_MORE_GARBOW_HILLSTROM_BROWN_ALMOST_LINEAR_HPP_
...
template <typename Vector, typename Matrix>
typename Vector::value_type brown_almost_linear<Vector, Matrix>::f_min = 0.0;

template <typename Vector, typename Matrix>
typename Vector::value_type brown_almost_linear<Vector, Matrix>::tolerance =
    std::numeric_limits<typename Vector::value_type>::epsilon();

template <typename Vector, typename Matrix>
std::vector<typename Vector::value_type>
    brown_almost_linear<Vector, Matrix>::minima = {};

template <typename Vector, typename Matrix>
std::vector<typename Vector::value_type>
    brown_almost_linear<Vector, Matrix>::x0 = {};
