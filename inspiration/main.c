...
line_search_test(F phi, const double stp0, const double& mu, const double eta){
    ...
    std::cout << std::setw(4) << nfev 
              << std::setw(16) << task 
              << std::scientific << std::setw(16) << stp0 
                                 << std::setw(16) << stp  
