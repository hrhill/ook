...
struct observer
{
    ...
    void operator()(const ook::lsm_state<vector_type>& s)
    {
        states.push_back(s);
    }
    ...
    std::string name;
    std::vector<ook::lsm_state<vector_type>> states;
};
