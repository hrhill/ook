...
/// Apart from a small region around the optimum this function is flat. Minimum
/// is f(100,100)=-10
double
...
powells_singular(const ook::vector& x, ook::vector& g, ook::matrix& /*H*/)
{
    ...
    double t3 = (x[2] - 2.0 * x[3]) * (x[2] - 2.0 * x[3]) *
        (x[2] - 2.0 * x[3]) * (x[2] - 2.0 * x[3]);
    double t4 =
        10.0 * (x[0] - x[3]) * (x[0] - x[3]) * (x[0] - x[3]) * (x[0] - x[3]);
    double f = t1 + t2 + t3 + t4;

    g[0] = 2 * (x[0] + 10 * x[1]) +
        40 * (x[0] - x[3]) * (x[0] - x[3]) * (x[0] - x[3]);
    g[1] = 20 * (x[0] + 10 * x[1]);
    g[2] = 10 * (x[2] - x[3]) +
        4 * (x[2] - 2 * x[3]) * (x[2] - 2 * x[3]) * (x[2] - 2 * x[3]);
    g[3] = -10 * (x[2] - x[3]) -
        8 * (x[2] - 2 * x[3]) * (x[2] - 2 * x[3]) * (x[2] - 2 * x[3]) -
        40 * (x[0] - x[3]) * (x[0] - x[3]) * (x[0] - x[3]);
...
powells_singular_f(const ook::vector& x)
{
    ...
    const double t3 = (x[2] - 2.0 * x[3]) * (x[2] - 2.0 * x[3]) *
        (x[2] - 2.0 * x[3]) * (x[2] - 2.0 * x[3]);
    const double t4 =
        10.0 * (x[0] - x[3]) * (x[0] - x[3]) * (x[0] - x[3]) * (x[0] - x[3]);
    return t1 + t2 + t3 + t4;
